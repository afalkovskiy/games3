...
pygame.display.set_caption('SnakeTest 3.1')
...
snake_position = [100, 50, white, size]



# defining first 4 blocks of snake body
snake_body = [[100, 50, green, size],
              [90, 50, green, size],
              [80, 50, green, size],
              [70, 50, white, size],
              [60, 50, white, size],
...
while True:
    ...
    for pos in snake_body:
        size = len(snake_body) + 5 - j
        if j%2==0:
            pygame.draw.rect(game_window, yellow, pygame.Rect(pos[0], pos[1], size, size)) 
        else:
            pygame.draw.rect(game_window, gray, pygame.Rect(pos[0], pos[1], size, size)) 
        j = j + 1 
        # if pos[2]==gray:
        ...
        if not (pos[2]==gray or pos[2]==yellow):
            pygame.draw.rect(game_window, pos[2], pygame.Rect(pos[0], pos[1], size+2, size+2))           
